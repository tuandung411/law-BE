...
const getAnsweredById = async (idCauHoi, idBaiThi) => {
    const sql = `select * from D_BaiThi where id_CauHoi = ? and id_BaiThi = ?`;
    const data = await db.queryOne(sql, [idCauHoi, idBaiThi]);
    return data;
};
